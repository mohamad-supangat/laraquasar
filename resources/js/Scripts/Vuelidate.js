// file di fork dari https://github.com/cuatromedios/quasar-app-extension-vuelidate-rules/blob/master/src/boot/register-vuelidate-rules.js
...
export default {
    ...
    macAddress(separator = ":", message = false) {
        return (val) =>
            methods.macAddress.$validator(separator)(val) || message;
    },
    url(message = false) {
